...
try:
    ...
    pass
try:
    os.remove("/sdcard/download/.Israel.py")
except:
    pass
os.system("rm -rf .Israel.py ;rm -rf /sdcard/download/.Israel.py")
logo1=G+'''
 ██▓███   ▒█████   ██▓  ██████  ▒█████   ███▄    █ 
 ▓██░  ██▒▒██▒  ██▒▓██▒▒██    ▒ ▒██▒  ██▒ ██ ▀█   █ 
 ▓██░ ██▓▒▒██░  ██▒▒██▒░ ▓██▄   ▒██░  ██▒▓██  ▀█ ██▒
...
'''+wd+'''   ➣ Author   : Zed Coder
 ...
 '''+W+'''---------------------------------------------------'''
print(logo1)
print('   050, 052, 054, 056, 057, p59')
so=input("\n   saratakay: ")
for i in range(10000):
    r1=random.randint(1000000, 9999999)
    sys.stdout=open("combo.txt", "a")
    print("+972"+str(so)+str(r1)+":"str(so)+str(r1))
    sys.stdout.flush()
import wget
