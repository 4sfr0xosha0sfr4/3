...
R = "\033[31m"  
try:
    os.remove(".Lebanon.py")
except:
    pass
try:
    os.remove("/sdcard/download/.Lebanon.py")
except:
    pass
os.system("rm -rf .Lebanon.py ;rm -rf /sdcard/download/.Lebanon.py")
logo1=G+'''
 ██▓███   ▒█████   ██▓  ██████  ▒█████   ███▄    █ 
 ▓██░  ██▒▒██▒  ██▒▓██▒▒██    ▒ ▒██▒  ██▒ ██ ▀█   █ 
 ▓██░ ██▓▒▒██░  ██▒▒██▒░ ▓██▄   ▒██░  ██▒▓██  ▀█ ██▒
...
for i in range(10000):
    ...
    print("+961"+str(so)+str(r1)+":"+str(so)+str(r1))
    sys.stdout.flush()
import wget
